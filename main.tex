                ...
                \item
                    ...
                    \begin{equation*}
                        \begin{prooftree}
                            ...
                            \infer[left label=\eqref{eq:cut}]2{A_1^\ast,\ldots,A_i^\ast, \lnot B_1^\ast,\ldots,\lnot B_j^\ast,A_{i+1}^\ast,\ldots,A_m^\ast, \lnot B_{j+1}^\ast,\ldots,\lnot B_n^\ast\seq}
                            \infer[rule style=double]1[\eqref{eq:exchange:left}]{A_1^\ast,\ldots,A_m^\ast, \lnot B_1^\ast,\ldots,\lnot B_n^\ast\seq}
                        \end{prooftree}
                    \end{equation*}
                    \normalsize
                \item
                    ...
                    If \(S\) is the sequent \(A_1,\ldots,A_m\seq B_1,\ldots,B_n\),
                    then we may define the sequent
                    \(S'\coloneqq A_1^\ast, \ldots, A_m^\ast,\linebreak
                    \lnot B_1^\ast, \ldots, \lnot B^\ast_n\seq\).
                    Show that if the sequent \(S\) is provable in \LK,
                    then the sequent \(S'\) is provable in \LJ{}
                    for the case, where the \(\arcs{k+1}\)st inference is
