...
a certain alphabe, with a specific goal of describing a certain set of objects.
In this course, the object language is used to describe mathematics and
is formed from the definitions~\ref{def:classical alphabet}--\ref{def:inference}.
We need to differentiate between the two languages and for that purpose, a hierarchical description is given in table
\ref{tab:language hierarchy}.

\begin{tabenv}{Language hierarchy.}%
