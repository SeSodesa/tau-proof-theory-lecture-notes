...
\begin{definition}[The alphabet of classical logic]
    ...
    \begin{enumerate}
        \item Constants:
            \begin{enumerate}
                \item Individual constants: \(\set{k_j}, j\in\Nset\).
                \item Function constants with \(i\) argument places: \(\set{f_j^i}, i,j\in\Nset\).
                \item Predicate constants with \(i\) arguent places: \(\set{R_j^i}, i, j\in\Nset\)
            \end{enumerate}
        \item Variables:
            \begin{enumerate}
                \item Free variables \(\set{a_j}, j\in\Nset\),
                \item Bound variables \(\set{x_j}, j\in\Nset\)
            \end{enumerate}
        \item The logical symbols \(\lnot\) (not), \(\land\) (and), \(\lor\), \(\limplies\) (implies),
        ...
        \item Auxiliary symbols: parentheses \((\) and \()\), and the comma \(,\).
    \end{enumerate}
    \label{def:the alphabet of classical logic}
\end{definition}
