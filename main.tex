...
\begin{equation*}
    \begin{prooftree}
        \hypo{A\seq A}
        \infer1[lor:right]{\seq A, \lnot A}
        \infer1[lor:right]{\seq A, A\lor\lnot A}
        \infer1[exchange:right]{\seq A\lor\lnot A, A\lor\lnot A}
        \infer1[lor:right]{\seq A\lor\lnot A, \lor\lnot A}
        \infer1[contraction:right]{\seq A \lor\lnot A}
    \end{prooftree}
\end{equation*}
\end{example}
