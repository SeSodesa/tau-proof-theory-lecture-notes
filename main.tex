...
\begin{align}\tag{eq:ax:1}\label{eq:ax:1}
    &\seq s = s, \\
\tag{eq:ax:2}\label{eq:ax:2}
    s_1 = t_1,\ldots,s_n = t_n &\seq f(s_1,\ldots,s_n) = f(t_1,\ldots,t_n) \\
\tag{eq:ax:3}\label{eq:ax:3}
...
\begin{proposition}[7.2]\label{prop:7.2}
    ...
    \begin{align}\tag{eq:symmetry}\label{eq:symmetry}
        s=t&\seq t=s\,,\\
    \tag{eq:transitivity}\label{eq:transitivity}
        s=t,t=v&\seq s=v\quad\text{and} \\
    \tag{eq:sequential symmetry}\label{eq:sequential symmetry}
