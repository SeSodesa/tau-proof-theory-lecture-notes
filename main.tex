        ...
        \item
            ...
            \begin{description}
                ...
                \item[\land]
                    ...
                    \end{equation*}
                \item[\lor]
                    \begin{exercise}[3.12.1]\label{exe:3.12.1}
                        This is left as an exercise. Show that \(A = A^\ast\), when \(A=A\lor B\).
                    \end{exercise}
                \item[\forall]
                ...
                \item[\limplies]
                    ...
                    \end{equation*}
                \item[\exists]
                    \begin{exercise}[3.12.2]\label{exe:3.12.2}
                        This is left as an exercise. Show that if \(A = \exists xB(x)\), then \(A\equiv B^\ast\).
                    \end{exercise}
            \end{description}
    \end{enumerate}
    By the inductive principle, we are then done.
