...
\begin{equation}\tag{eq:ax:1}\label{eq:ax:1}
    \seq s = s,
\end{equation}
\begin{equation}\tag{eq:ax:2}\label{eq:ax:2}
    s_1 = t_1,\ldots,s_n = t_n \seq f(s_1,\ldots,s_n) = f(t_1,\ldots,t_n)
\end{equation}
\begin{equation}\tag{eq:ax:3}\label{eq:ax:3}
    s_1 = t_1,\ldots,s_n = t_n \seq R(s_1,\ldots,s_n)\seq R(s_1,\ldots,s_n)
\end{equation}
The statements~\eqref{eq:ax:1}--\eqref{eq:ax:3} for the equality axioms.
...
\begin{proposition}[7.2]\label{prop:7.2}
    ...
    \begin{enumerate}
        \item\label{it:substitution 1}
            \(s=t\seq t=s\),
        \item\label{it:substitution 2}
            \(s=t,t=v\seq s=v\) and
        \item\label{it:substitution 3}
