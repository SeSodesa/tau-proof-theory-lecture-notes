...
\begin{theorem}[7.6]\label{the:7.6}
    If a sequent \(\Gamma\seq\Delta\) is provable in \(\LK_=\),
    then it is provable without an essential \eqref{eq:cut}.
\end{theorem}
...
\begin{proof}
    \begin{exercise}[7.6]\label{exe:7.6}
        ...
        axioms or it is obtained by weakening.
    \end{exercise}
\end{proof}
