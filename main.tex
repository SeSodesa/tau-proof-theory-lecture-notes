...
\begin{equation*}
    \begin{prooftree}
        ...
        \hypo{A\seq A}
        \infer1{\lnot A, A\seq}
        \infer1{\lnot A\land\lnot B, A\seq}
        \infer1{A, \lnot A\land\lnot B}
        % right branch
        \hypo{B\seq B}
        \infer1{\lnot B, B\seq}
        \infer1{\lnot A\land\lnot B, B\seq}
        \infer1{B, \lnot A\land\lnot B}
        % Trunk
        \infer2{A\lor B, \lnot A \land\lnot B\seq}
        \infer1{\lnot A \land\lnot B, A\lor B\seq}
        \infer1{A\lor B \seq\lnot\arcs{\lnot A \land\lnot B}}
        \infer1{\seq A\lor B\limplies\lnot\arcs{\lnot A\land\lnot B}}
    \end{prooftree}
\end{equation*}
...
\begin{equation*}
    \begin{prooftree}
        ...
        \hypo{A\seq A}
        \infer1{A\seq A\lor B}
        \infer1{\seq A\lor B, \lnot A}
        \hypo{B\seq B}
        \infer1{B\seq A\lor B}
        \infer1{\seq A\lor B, \lnot B}
        \infer2{\seq A\lor B, \lnot A\land\lnot B}
        \infer1{\lnot\arcs{\lnot A \land\lnot B}\seq A\lor B}
        \infer1{\seq\lnot\arcs{\lnot A \land\lnot B}\limplies A\lor B}
    \end{prooftree}<++>
\end{equation*}<++>
