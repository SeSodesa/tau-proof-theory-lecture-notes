...
\begin{proof}[Sketch of proof]
    ...
    \begin{equation*}
        \begin{prooftree}
            ...
            \infer2[\eqref{eq:cut} and \eqref{eq:exchange:right}]{\lnot B_n^\ast,\ldots,\lnot B_1^\ast\seq\lnot A_m,\ldots,\lnot A_1^\ast,\lnot A_2}
            ...
            \infer2[\eqref{eq:cut}]{\lnot\lnot A_1^\ast,\ldots,\lnot\lnot A_m^\ast, \lnot B_n^\ast,\ldots,\lnot B_1^\ast\seq}
        \end{prooftree}
    \end{equation*}
    \normalsize
    is valid, then
