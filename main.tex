...
\begin{proof}
    \begin{equation}\label{exe:2.5.4:eq:1}
        \begin{prooftree}
            ...
            \infer1[\eqref{eq:lnot:left}]{\forall y F(y)\seq \exists x\lnot F(x)}
...
\begin{equation*}
    ...
    \end{prooftree}
\end{equation*}
    Note that this is not possible in \IK.
\end{example}
...
\begin{example}[A cut free proof]\label{exa:cut free proof}
    ...
    \begin{equation*}
        \begin{prooftree}
            \hypo{A(a)\seq A(a)}
            \infer1{A(a)\seq A(a), \forall x A(x)}
            \hypo{B\seq B}
            \infer2{A(a), \forall xA(x)\limplies B\seq, A(a), B}
            \infer1{\forall xA(x)\limplies B, A(a)\seq, A(a), B}
            \infer1{\forall xA(x)\limplies B\seq A(a), A(a)\limplies B}
            \infer1{\forall xA(x)\limplies B\seq A(a), \exists x\arcs{A(x)\limplies B}}
            \infer1{\forall xA(x)\limplies B\seq\exists x\arcs{A(x)\limplies B}, A(a)}
            \infer1{\forall xA(x)\limplies B\seq\exists x\arcs{A(x)\limplies B}, \forall x A(x)}
            \hypo{B\seq B}
            \infer1{A(a), B\seq B}
            \infer1{B\seq A(a)\limplies B}
            \infer1{B\seq\exists x\arcs{A(x)\limplies B}}
            \infer2{\forall x A(x)\limplies B, \forall x A(x)\limplies B \seq \exists x \arcs{A(x)\limplies B}, \exists x \arcs{A(x)\limplies B}}
            \infer1{\forall x A(x)\limplies B \seq \exists x \arcs{A(x)\limplies B}, \exists x \arcs{A(x)\limplies B}}
            \infer1{\forall x A(x)\limplies B \seq \exists x \arcs{A(x)\limplies B}}
            \infer1{\seq\arcs{\forall x A(x)\limplies B}\limplies\arcs{\exists x \arcs{A(x)\limplies B}}}
        \end{prooftree}
    \end{equation*}
\end{example}
...
\begin{exercise}[Exercise 2.6.1]\label{exe:2.6.1}
    Prove \(\exists x\arcs{A\limplies B(x)}\equiv\forall xA(x)\limplies\exists xB(x)\).
\end{exercise}
\begin{exercise}[Exercise 2.6.2]\label{exe:2.6.2}
    Prove \(\exists x\arcs{A(x)\limplies B}\equiv\forall xA(x)\limplies\exists xB\),
