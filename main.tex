...
\begin{definition}[Reduction tree]\label{def:reduction tree}
    ...
    \begin{enumerate}
        ...
        \item\label{it:reduction tree loop}
                ...
                \item\label{it:reduction tree unfinished}
                    ...
                    \begin{enumerate}
                        ...
                        \item\label{it:reduction tree land right}
                            ...
                            \begin{equation}
                                \begin{prooftree}
                                    ...
                                    \hypo{\Pi\seq\Lambda,C_1,\ldots,C_n}
                                    \infer1{\Pi\seq\Lambda}
                                \end{prooftree}
                            \end{equation}
                        ...
                        \item\label{it:reduction tree lor left}
                            ...
                            \begin{equation}
                                \begin{prooftree}
                                    ...
                                    \hypo{C_1,\ldots,C_n,\Pi\seq\Lambda}
                                    \infer1{\Pi\seq\Lambda}
                                \end{prooftree}
                            \end{equation}
                            where each \(C_i\in\set{A_i, B_i}\).
                        ...
                        \item\label{it:reduction tree limplies left}
                            ...
                            \begin{equation}
                                \begin{prooftree}
                                    ...
                                    \hypo{B_1,\ldots,B_n,\Pi\seq\Lambda, A_1, \ldots, A_n}
                                    \infer1{\Pi\seq\Lambda}
                                \end{prooftree}
                            \end{equation}
                        ...
                        \item\label{it:reduction tree else}
                            ...
                            do nothing. If the sequences \(\Pi\) and \(\Lambda\) have \emph{nothing}
            ...
            continue iterating over the unhanded leaves, else jump
