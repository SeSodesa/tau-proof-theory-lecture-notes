...
of axioms concerning the terms \(s\), \(t\), \(s_i\), \(t_i\),
function symbols \(f\) and predicate symbols \(R\):
\begin{enumerate}
    \item\label{it:equality 1}
        \(\seq s = s\),
    \item\label{it:equality 2}
        If \(s_i = t_i\) for all \(i\in\set{1,\ldots,n}\),
        then \(f(s_1,\ldots,s_n) = f(t_1,\ldots,t_n)\).
    \item\label{it:equality 3}
        If \(s_i = t_i\) for all \(i\in\set{1,\ldots,n}\),
        then the sequent \(R(s_1,\ldots,s_n)\seq R(s_1,\ldots,s_n)\)
        is provable.
    \item\label{it:equality 4}
        The statements~\ref{it:equality 1}--\ref{it:equality 3}
